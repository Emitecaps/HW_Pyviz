### In this real estate analysis, there are 2 main workbooks. The 1st notebook is rental_analysis.ipnyb where the 2nd notebook Dashboard.ipynb will be built. 
